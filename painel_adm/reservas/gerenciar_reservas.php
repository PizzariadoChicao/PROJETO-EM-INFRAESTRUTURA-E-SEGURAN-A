             ...
             <div class="grid-x">
               <div class="cell auto"></div>
                ...
                <div class="cell small-12 medium-6 large-6">
                  ...
                  <h2 class="form-cad">Gerenciar Reservas</h2>
            ...
            <div class="cell small-12 medium-12 large-12">
             <table>   
              ...
              <tr style='text-align: center; font-family: Arial'>
                ...
                <td><?php echo $dado["convidados"]; ?></td>
                <td><?php echo $dado["dia"]; ?></td>
                <td><?php echo $dado["horario"]; ?></td>
                <td><?php echo $dado["obs"]; ?></td>
                <td><a href = "finalizar_reserva.php?reserva=<?php echo $dado["id"]; ?>">Finalizar<a>
                <td><a href = "editar_reserva.php?id=<?php echo $dado["id"]; ?>">Clique<a>
              </tr>
               <?php } ?> 
