            ...
            <div class="container-fluid " id="nav-container">
                ...
                <nav class="navbar navbar-expand-lg" id="menus">	
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbar-links">
                        ...
                        <a class="nav-link nav-item" id="cardapio" href="painel_adm/admin-login.html">Painel Administrativo</a>
                    </div>
                </nav>
            </div>
        </header>
				...
				<div>
					<form action="envio.php" method="POST">
						...
						<div>
							...
							<input type="text" id="telefone" class="inpu" name="telefone" onkeydown="javascript: fMasc( this, mTel );" required="">
						</div>
						<div>
